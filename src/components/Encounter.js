...
export default class Encounter extends Component {
    ...
    render () {
        this.props.combatants.forEach(combatant => (combatant.hitPoints ? combatant : combatant.hitPoints = ((Number(combatant.hitDiceNumber) * Math.floor(Math.random() * Number(combatant.hitDiceType))) + Number(combatant.hitPointsAdd) + combatant.hitDiceNumber).toString()))
