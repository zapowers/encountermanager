...
class Dice extends Component {
    ...
    async handleSubmit (evt) {
        evt.preventDefault()
        let result = ((Number(this.state.diceNumber) * Math.floor(Math.random() * Number(this.state.diceType))) + Number(this.state.diceAdder) + (Number(this.state.diceNumber))).toString()
